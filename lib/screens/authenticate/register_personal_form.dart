...
class RegisterPersonalForm extends StatefulWidget {
  ...
  RegisterPersonalForm({this.toggleView});

  @override
  _RegisterPersonalFormState createState() => _RegisterPersonalFormState();
}
        ...
        : Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                TextFormField(
                  decoration:
                      textInputDecoration.copyWith(hintText: "Nom & Prénoms"),
                  validator: (value) =>
